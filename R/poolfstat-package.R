...
#' @importFrom stats quantile heatmap dist hclust sd cov reorder as.dist qnorm
#' @importFrom Rcpp evalCpp
#' @importFrom DiagrammeR grViz
#' @importFrom ape nj dist.nodes
#' @importFrom graphics abline arrows par text
# #' @importFrom pracma grad
#' @importFrom zoo rollsum rollmean
...
##NULL
globalVariables(c("nr", "nc")) ##to prevent a note with R CMD check related to interfacing of heatmap with a methods associated to the objects pariwefst (see out.objects.R)